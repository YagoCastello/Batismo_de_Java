package intermediario.Ninjas_inicio.NEW_REVISAO.CLASSE.GetterSettersss;

public abstract class Aburame {
    ...
    public Aburame(String nome, String aldeia, int idade, int numeroDeMissoesConcluidas, double altura) {
        this.nome = nome;
        this.aldeia = aldeia;
        this.idade = idade;
