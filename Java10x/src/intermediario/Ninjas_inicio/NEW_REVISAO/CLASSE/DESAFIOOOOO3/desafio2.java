    ...
    public static void main(String[] args) {
        ...
        while (opcao != 4){
            ...
            switch (opcao){
                ...
                case 3:
                    if(cadastrados == 0){
                        System.out.println("Não tem cadastrados, impossível mudar a habilidade especial. ");

                    }else{System.out.println("Informe o nome do ninja que você quer mudar a habilidade especial: ");
